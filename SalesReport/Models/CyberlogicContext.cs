...
public partial class CyberlogicContext : DbContext
{
    public CyberlogicContext()
    {
    }

    public CyberlogicContext(DbContextOptions<CyberlogicContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<SalesLtSalesPerson> SalesLtSalesPeople { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=cloete.database.windows.net;Initial Catalog=cyberlogic;User ID=cyberadmin;Password=8C5MVC7VohJcqW;Connect Timeout=60;Encrypt=True;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECAD84D7E73");
        ...
        modelBuilder.Entity<SalesLtSalesPerson>(entity =>
        {
            entity.ToTable("SalesLT.SalesPerson");
        ...
        modelBuilder.Entity<SalesOrderDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.SalesPerson).WithMany(p => p.SalesOrderDetails)
                .HasForeignKey(d => d.SalesPersonId)
                .HasConstraintName("FK_SalesOrderDetail_SalesPerson_ID");
        });
